			...
			>
				<div className="max-w-sm gap-6 sm:max-w-md md:max-w-xl mx-auto flex h-full w-full flex-col justify-center">
					<div className="gap-y-6 flex flex-col">
						...
						{!savedServers.length && (
							<div className="p-4 border-edge-subtle rounded-lg border border-dashed text-muted-foreground select-none">
								{t(getKey('getStarted'))}
							</div>
						)}

						{savedServers.length > 0 && (
							<Card className="divide-edge flex flex-col divide-y bg-card">
