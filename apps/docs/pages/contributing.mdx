...
Contributions are very **encouraged** and **welcome**! Be sure to review the [CONTRIBUTING.md](https://github.com/stumpapp/stump/blob/main/CONTRIBUTING.md) before getting started with your contribution.
