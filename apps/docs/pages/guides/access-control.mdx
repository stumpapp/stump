...
- If the book nor the series has an age restriction set, the book will be considered allowed UNLESS a user has an age restriction with the `restrict_on_unset` option set.
