...
You can automate scans using the job scheduler. See the [Background Jobs](/guides/basics/background-jobs) guide for details on creating and managing scheduled jobs.
