...
<Callout emoji="📱" type="info">
	These placeholders are currently only supported by the mobile app. The web app does not yet
	support them. If you would like to see this feature added to the web app, please let me know and I
