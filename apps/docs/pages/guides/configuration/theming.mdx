...
<Callout type="info">
Support for arbitrary, local CSS files to override Stump's default themes is planned. You can track the progress of this feature in [issue #383](https://github.com/stumpapp/stump/issues/383).
</Callout>
