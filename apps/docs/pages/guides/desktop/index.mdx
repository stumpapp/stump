...
You might have noticed the [TestFlight](https://testflight.apple.com/join/a4srR634) app is available for installation on macOS. This is actually the iPadOS version of the [mobile application](/guides/mobile), which is able to run on some macOS devices. This is **not** the same as the desktop application described throughout this section of the documentation.
