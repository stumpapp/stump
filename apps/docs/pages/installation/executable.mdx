...
On [GitHub](https://github.com/stumpapp/stump/releases), Stump has pre-built binaries, for both the Stump server and desktop application, for Linux, macOS, and Windows platforms.
