...
export const sidebarItems: SidebarItem[] = [
	...
	},
	{
		...
		links: [
			...
			{ href: '/guides/library-explorer', description: 'Library File Explorer' },
			{ href: '/guides/series', description: 'Series' },
			{ href: '/guides/jobs', description: 'Background Jobs' },
			...
			{ href: '/guides/readers', description: 'Built-in Readers' },
