    ...
    override fun definition() =
        ModuleDefinition {
            ...
            AsyncFunction("openPublication") Coroutine { bookId: String, publicationUri: URL ->
                return@Coroutine bookService
                    .openPublication(bookId, publicationUri)
                    .manifest
            }
