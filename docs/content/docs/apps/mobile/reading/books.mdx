...
<Callout>
    Make sure to check out the [shared features documentation](/docs/apps/mobile/reading/shared-features) for functionality that is common across different book formats. This section will focus on features specific to the EPUB reader
</Callout>
...
- **Header Controls**: Exit the reader
- **Footer Controls**: Progress indicator and the menu button

Use the menu button to access the table of contents, bookmarks, highlights, annotations, reader settings, and preview the reading time.

### Table of Contents

Access the book's table of contents to jump to specific chapters, sections, or pages. The table of contents preserves the hierarchical structure of the book.

### Annotations

The annotations sheet lists all types of annotations you've made in the book, including:
