---
title: Comics/Manga
description: Comics, Manga, and other image-based formats
---
...
<Callout>
    Make sure to check out the [shared features documentation](/docs/apps/mobile/reading/shared-features) for functionality that is common across different book formats. This section will focus on features specific to image-based readers
</Callout>
...
<Callout type="warning">
	Image zooming is funky when using the scroll flows. This is a known issue and will be
...
- **Fit Height**: Scales images to fit the screen height ⚠️ _Currently disabled_
