...
Quick access to switch between your configured servers. See the [default server](/guides/mobile/servers#default-server) section for more information about server management.
