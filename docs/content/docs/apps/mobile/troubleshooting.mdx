...
This is likely due to a misconfiguration of your Stump server. If you are running a reverse proxy, you need to instruct Stump to trust the [corresponding headers](/guides/configuration/server-config#STUMP_TRUST_PROXY_HEADERS) that it may receive.
