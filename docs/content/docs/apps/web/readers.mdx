...
The reader supports themes, reading direction, search, bookmarks, and annotations. Reading progress is stored as Readium locators, shared with the mobile app.
