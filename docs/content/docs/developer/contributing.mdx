...
If you'd like to help translate Stump into other languages, you can do so [here](https://crowdin.com/project/stump). You can do as little or as much as you'd like at a time! If you don't see your language listed, please open an issue on GitHub.
