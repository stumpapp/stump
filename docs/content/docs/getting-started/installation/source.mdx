...
The [contributing guide](/contributing) provides detailed instructions on installing the necessary dependencies for building Stump from source. Please follow those instructions to set up your development environment.
