...
Unfortunately, Stump does not support any other patterns, as there are simply too many ways to organize a library to support them all. If you have a library that doesn't quite fit either of these patterns, or you just prefer a differnt organization method, you can always use the [File Explorer](/guides/file-explorer) to navigate your library. This is akin to using a native file explorer to navigate your filesystem.
