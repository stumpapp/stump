...
const FilterContentWrapper = forwardRef<HTMLDivElement, Props>(
...
FilterContentWrapper.displayName = 'FilterContentWrapper'

export default FilterContentWrapper
