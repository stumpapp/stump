	...
	return (
		<>
			...
			<DropdownMenu
				modal={isMobile}
				trigger={
					<button className="p-1 text-opacity-50 hover:text-opacity-100 data-[state=open]:text-opacity-100 text-foreground-muted outline-none focus:ring-0 focus:ring-offset-0">
