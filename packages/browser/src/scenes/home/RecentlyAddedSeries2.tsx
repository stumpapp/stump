...
import { graphql, RecentlyAddedSeriesQuery2Query } from '@stump/graphql'
...
export const usePrefetchRecentlyAddedSeries2 = () => {
	const { sdk } = useSDK()
...
type RecentlyAddedSeriesCardProps = {
	series: RecentlyAddedSeriesQuery2Query['recentlyAddedSeries']['nodes'][number]
	cardWidth: number
}
