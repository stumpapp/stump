		...
		<div className="gap-4 flex flex-col">
			...
			<div className="gap-12 md:gap-8 flex flex-row flex-wrap">
				{version && (
					<div>
						<Label>
							{t('settingsScene.server/general.sections.serverInfo.labels.semanticVersion')}
						</Label>
						<Link
							href={versionUrl}
							target="__blank"
				...
				{buildChannel && (
					<div>
						<Label>
							{t('settingsScene.server/general.sections.serverInfo.labels.buildChannel')}
						</Label>
				...
				{version && (
					<div>
						<Label>
							{t('settingsScene.server/general.sections.serverInfo.labels.exactCommit')}
						</Label>
						<Link
							href={commitUrl}
							target="__blank"
				...
				{version && (
					<div>
						<Label>{t('settingsScene.server/general.sections.serverInfo.labels.buildDate')}</Label>
						<Text size="sm" variant="muted">
