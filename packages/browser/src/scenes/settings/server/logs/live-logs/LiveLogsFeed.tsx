...
export default function LiveLogsFeed() {
	...
	return (
		<div className="h-72 p-4 rounded-xl border border-border bg-card text-card-foreground">
			<div
				ref={logContainerRef}
				className="gap-y-1.5 font-mono text-sm flex max-h-full flex-col overflow-y-auto text-muted-foreground"
			>
