...
export default function SmartListCard({
	...
	return (
		<Link to={paths.smartList(id)} className="block w-full">
			<Card
				className="bg-background-surface flex h-32 w-full flex-col gap-y-4 rounded-none border-none p-4 transition-colors duration-150 first:rounded-t-sm last:rounded-b-sm hover:bg-background-300/80"
