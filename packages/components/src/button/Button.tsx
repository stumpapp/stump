...
export const BUTTON_VARIANTS = {
	...
	default: 'bg-background-surface hover:bg-background-300 text-foreground focus:ring-brand-400',
	ghost:
		'bg-transparent hover:bg-background-300 text-foreground-subtle data-[state=open]:bg-transparent',
	...
	subtle: 'bg-background-300 hover:bg-background-400 text-foreground-subtle',
	'subtle-dark':
