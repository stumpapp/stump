...
>(({ className, align = 'center', sideOffset = 4, ...props }, ref) => (
	<HoverCardPrimitiveContent
		...
		className={cn(
			'w-64 p-4 shadow-2xl z-50 animate-in rounded-2xl border border-border bg-popover text-popover-foreground ring-1 ring-foreground/5 outline-none zoom-in-90',
			className,
		)}
		{...props}
	/>
