...
>(({ className, ...props }, ref) => (
	<ContextMenu.SubContent
		ref={ref}
		className={cn(
			'min-w-32 p-1 shadow-md z-50 animate-in overflow-hidden rounded-md border border-border bg-popover text-popover-foreground slide-in-from-left-1',
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<ContextMenu.Portal>
		<ContextMenu.Content
			ref={ref}
			className={cn(
				'min-w-32 p-1 shadow-md z-50 animate-in overflow-hidden rounded-md border border-border bg-popover text-popover-foreground fade-in-80',
				className,
			)}
			{...props}
		/>
