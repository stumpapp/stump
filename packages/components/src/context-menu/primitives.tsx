...
>(({ className, ...props }, ref) => (
	<ContextMenu.Portal>
		<ContextMenu.Content
			ref={ref}
			className={cn(
				'z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-100 bg-white p-1 text-gray-700 shadow-md animate-in fade-in-80 dark:border-gray-800 dark:bg-gray-800 dark:text-gray-400',
				className,
			)}
			{...props}
		/>
