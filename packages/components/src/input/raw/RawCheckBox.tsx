...
export const RAW_CHECKBOX_BASE_CLASSES =
	'peer group/checkbox relative shrink-0 border border-border bg-background text-foreground transition-shadow outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:border-primary data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground data-[state=indeterminate]:border-primary data-[state=indeterminate]:bg-primary data-[state=indeterminate]:text-primary-foreground aria-invalid:border-field-error-border aria-invalid:ring-[3px] aria-invalid:ring-field-error-ring aria-invalid:data-[state=checked]:border-primary dark:bg-input/30'
		...
		>
			...
			>
				<Check
					aria-hidden="true"
					className={cn(
						'font-medium hidden text-current group-data-[state=checked]/checkbox:block',
						{
				...
				<Minus
					aria-hidden="true"
					className={cn(
						'font-medium hidden text-current group-data-[state=indeterminate]/checkbox:block',
						{
							'size-3.5': (size || 'default') === 'default',
							'size-3': size === 'sm',
							'size-4': size === 'md',
