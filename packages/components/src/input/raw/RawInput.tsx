...
export const RAW_INPUT_BASE_CLASSES = [
	...
	'focus:ring-offset-background focus:outline-none focus:ring-2 focus:ring-edge-focus focus:ring-offset-2 focus:ring-offset-background',
...
export const RAW_INPUT_VARIANT = {
	...
	primary: 'focus:ring-edge-focus dark:focus:ring-edge-focus',
	underline:
