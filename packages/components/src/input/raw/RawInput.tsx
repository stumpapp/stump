...
export const RAW_INPUT_VARIANTS = {
	...
	ghost:
		'border-opacity-0 hover:border-opacity-70 focus:border-opacity-100 dark:hover:border-opacity-70 dark:focus:border-opacity-100 dark:border-opacity-0 dark:hover:bg-gray-900/50 dark:focus:bg-transparent dark:focus:ring-offset-gray-900',
