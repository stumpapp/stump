...
export type ArrangementConfig =
	| CustomArrangementConfig
	| InProgressBooks
	| RecentlyAdded
	| SystemArrangmentConfig
...
export type CoreEvent =
	...
	| DiscoveredMissingLibrary
	| JobOutput
	| JobStarted
	| JobUpdate

export type CoreJobOutput =
	| ExternalJobOutput
	| LibraryScanOutput
	| SeriesScanOutput
...
export type NumericFilterDateTime =
	| {
			anyOf: Array<Scalars['DateTime']['input']>
			eq?: never
			gt?: never
			gte?: never
			lt?: never
	...
	| {
			...
			lte?: never
			neq?: never
			noneOf: Array<Scalars['DateTime']['input']>
			range?: never
	  }
	| {
			anyOf?: never
...
export type NumericFilterI32 =
	...
	| {
			...
			lte?: never
			neq?: never
			noneOf: Array<Scalars['Int']['input']>
			range?: never
	  }
	| {
			anyOf?: never
...
export type DeleteLibraryMutation = {
	__typename?: 'Mutation'
	deleteLibrary: { __typename?: 'Library'; id: string }
}
...
export type UpdateLibraryEmojiMutation = {
	__typename?: 'Mutation'
	updateLibraryEmoji: { __typename?: 'Library'; id: string }
}
...
export type LibrarySideBarSectionQuery = {
	__typename?: 'Query'
	libraries: {
		__typename?: 'PaginatedLibraryResponse'
		nodes: Array<{ __typename?: 'Library'; id: string; name: string; emoji?: string | null }>
	}
}
...
export type UpdateEpubProgressMutation = {
	__typename?: 'Mutation'
	updateEpubProgress: { __typename: 'ReadingProgressOutput' }
}
...
export type CreateOrUpdateBookmarkMutation = {
	__typename?: 'Mutation'
	createOrUpdateBookmark: { __typename: 'Bookmark' }
}
...
export type UsePreferencesMutation = {
	__typename?: 'Mutation'
	updateViewerPreferences: { __typename: 'UserPreferences' }
}
...
export type BookFileInformationFragment = {
	__typename?: 'Media'
	id: string
	size: number
	extension: string
...
} & { ' $fragmentName'?: 'BookFileInformationFragment' }

export type BookLibrarySeriesLinksQueryVariables = Exact<{
	id: Scalars['ID']['input']
}>

export type BookLibrarySeriesLinksQuery = {
	__typename?: 'Query'
	...
	mediaById?:
		| ({
				...
				' $fragmentRefs'?: {
					...
					BookFileInformationFragment: BookFileInformationFragment
				}
		  })
		| null
}
...
export type BooksAfterCurrentQueryQuery = {
	__typename?: 'Query'
	mediaById?: {
		__typename?: 'Media'
		nextInSeries: {
...
export type BookReaderSceneQuery = {
	__typename?: 'Query'
	mediaById?: {
		__typename?: 'Media'
		id: string
...
export type UpdateReadProgressMutation = {
	__typename?: 'Mutation'
	updateMediaProgress: { __typename: 'ReadingProgressOutput' }
}
...
export type CreateLibrarySceneCreateLibraryMutation = {
	__typename?: 'Mutation'
	createLibrary: { __typename?: 'Library'; id: string }
}

export type CreateSmartListFormQueryVariables = Exact<{ [key: string]: never }>

export type CreateSmartListFormQuery = {
	__typename?: 'Query'
	smartLists: Array<{ __typename?: 'SmartList'; name: string }>
}
...
export type CreateSmartListSceneMutation = {
	__typename?: 'Mutation'
	createSmartList: { __typename?: 'SmartList'; id: string; name: string }
}
...
export type ContinueReadingMediaQueryQuery = {
	__typename?: 'Query'
	keepReading: {
		__typename?: 'PaginatedMediaResponse'
		nodes: Array<
...
export type RecentlyAddedMediaQueryQuery = {
	__typename?: 'Query'
	recentlyAddedMedia: {
		__typename?: 'PaginatedMediaResponse'
		nodes: Array<
...
export type RecentlyAddedSeriesQueryQuery = {
	__typename?: 'Query'
	recentlyAddedSeries: {
		__typename?: 'PaginatedSeriesResponse'
		nodes: Array<{
...
export type LibrarySeriesGridQuery = {
	__typename?: 'Query'
	series: {
		__typename?: 'PaginatedSeriesResponse'
		nodes: Array<{
...
export type LibrarySettingsConfigFragment = {
	...
	config: {
		...
		thumbnailConfig?: {
			...
			page?: number | null
			resizeMethod?:
				| { __typename: 'ExactDimensionResize'; width: number; height: number }
				| { __typename: 'ScaleEvenlyByFactor'; factor: any }
				| { __typename: 'ScaledDimensionResize'; dimension: Dimension; size: number }
				| null
		} | null
	}
...
export type LibraryExclusionsUsersQueryQuery = {
	__typename?: 'Query'
	users: {
		__typename?: 'PaginatedUserResponse'
		nodes: Array<{ __typename?: 'User'; id: string; username: string }>
	}
}
...
export type LibraryExclusionsQueryQuery = {
	__typename?: 'Query'
	libraryById?: {
		__typename?: 'Library'
		excludedUsers: Array<{ __typename?: 'User'; id: string; username: string }>
	} | null
}
...
export type UpdateLibraryExclusionsMutation = {
	__typename?: 'Mutation'
...
export type CleanLibraryMutation = {
	__typename?: 'Mutation'
	cleanLibrary: {
		__typename?: 'CleanLibraryResponse'
...
export type ScanHistorySectionClearHistoryMutation = {
	__typename?: 'Mutation'
	clearScanHistory: number
}
...
export type ScanHistoryTableQuery = {
	__typename?: 'Query'
	libraryById?: {
		__typename?: 'Library'
		id: string
...
export type ScanRecordInspectorJobsQuery = {
	...
	jobById?: {
		...
		outputData?:
			...
			| { __typename: 'ThumbnailGenerationOutput' }
			| null
		logs?: Array<{ __typename?: 'Log'; id: number }>
	} | null
}
...
export type DeleteLibraryThumbnailsMutation = {
	__typename?: 'Mutation'
	deleteLibraryThumbnails: boolean
}
...
export type LibraryThumbnailSelectorUpdateMutation = {
	__typename?: 'Mutation'
...
export type LibraryThumbnailSelectorUploadMutation = {
	__typename?: 'Mutation'
...
export type RegenerateThumbnailsMutation = {
	__typename?: 'Mutation'
	generateLibraryThumbnails: boolean
}
...
export type SeriesLayoutQuery = {
	...
	seriesById?: {
		...
		library: { __typename?: 'Library'; id: string; name: string }
		tags: Array<{ __typename?: 'Tag'; id: number; name: string }>
	} | null
}
...
export type SeriesLibrayLinkQuery = {
	__typename?: 'Query'
	libraryById?: { __typename?: 'Library'; id: string; name: string } | null
}
...
export type SeriesBookGridQuery = {
	__typename?: 'Query'
	media: {
		__typename?: 'PaginatedMediaResponse'
		nodes: Array<{
...
export type ApiKeyTableQuery = {
	...
	apiKeys: Array<{
		...
		permissions:
			| { __typename: 'InheritPermissionStruct' }
			| { __typename: 'UserPermissionStruct'; value: Array<UserPermission> }
	}>
}
...
export type CreateApiKeyModalMutation = {
	...
	createApiKey: {
		__typename?: 'CreatedAPIKey'
		secret: string
		apiKey: { __typename?: 'Apikey'; id: number }
	}
}
...
export type DeleteApiKeyConfirmModalMutation = {
	__typename?: 'Mutation'
	deleteApiKey: { __typename?: 'Apikey'; id: number }
}
...
export type UpdateUserLocaleSelectorMutation = {
	__typename?: 'Mutation'
	updateViewerPreferences: { __typename?: 'UserPreferences'; locale: string }
}
...
export type UpdateUserProfileFormMutation = {
	__typename?: 'Mutation'
	updateViewer: { __typename?: 'User'; id: string; username: string; avatarUrl?: string | null }
}

export type CreateEmailerSceneEmailersQueryVariables = Exact<{ [key: string]: never }>

export type CreateEmailerSceneEmailersQuery = {
	__typename?: 'Query'
	emailers: Array<{ __typename?: 'Emailer'; name: string }>
}
...
export type CreateEmailerSceneCreateEmailerMutation = {
	__typename?: 'Mutation'
	createEmailer: { __typename?: 'Emailer'; id: number }
}
...
export type EditEmailerSceneQuery = {
	__typename?: 'Query'
	emailers: Array<{ __typename?: 'Emailer'; name: string }>
	emailerById?: {
		__typename?: 'Emailer'
...
export type EditEmailerSceneEditEmailerMutation = {
	__typename?: 'Mutation'
	updateEmailer: { __typename?: 'Emailer'; id: number }
}
...
export type CreateOrUpdateDeviceModalCreateEmailDeviceMutation = {
	__typename?: 'Mutation'
	createEmailDevice: { __typename?: 'RegisteredEmailDevice'; id: number; name: string }
}
...
export type CreateOrUpdateDeviceModalUpdateEmailDeviceMutation = {
	__typename?: 'Mutation'
	updateEmailDevice: {
		__typename?: 'RegisteredEmailDevice'
		id: number
...
export type DeleteDeviceConfirmationDeleteEmailDeviceMutation = {
	__typename?: 'Mutation'
	deleteEmailDevice: { __typename?: 'RegisteredEmailDevice'; id: number }
}

export type EmailDevicesTableQueryVariables = Exact<{ [key: string]: never }>

export type EmailDevicesTableQuery = {
	__typename?: 'Query'
	emailDevices: Array<{
		__typename?: 'RegisteredEmailDevice'
		id: number
...
export type EmailerListItemFragment = {
	__typename?: 'Emailer'
	id: number
	name: string
	isPrimary: boolean
	...
	tlsEnabled: boolean
	username: string
} & { ' $fragmentName'?: 'EmailerListItemFragment' }
...
export type EmailerSendHistoryQuery = {
	__typename?: 'Query'
	emailerById?: {
		__typename?: 'Emailer'
		sendHistory: Array<{
			...
			sentBy?: { __typename?: 'User'; id: string; username: string } | null
			attachmentMeta: Array<{
				__typename?: 'AttachmentMeta'
				filename: string
				mediaId?: string | null
				size: number
				media?: { __typename?: 'Media'; resolvedName: string } | null
			}>
		}>
	} | null
}
...
export type DeleteJobHistoryConfirmationMutation = {
	__typename?: 'Mutation'
	deleteJobHistory: { __typename?: 'DeleteJobHistory'; affectedRows: number }
}
...
export type JobActionMenuDeleteLogsMutation = {
	__typename?: 'Mutation'
	deleteJobLogs: { __typename?: 'DeleteJobAssociatedLogs'; affectedRows: number }
}

type JobDataInspector_ExternalJobOutput_Fragment = { __typename: 'ExternalJobOutput'; val: any } & {
	' $fragmentName'?: 'JobDataInspector_ExternalJobOutput_Fragment'
}

type JobDataInspector_LibraryScanOutput_Fragment = {
	__typename: 'LibraryScanOutput'
	totalFiles: number
	totalDirectories: number
	ignoredFiles: number
	...
	createdSeries: number
	updatedSeries: number
} & { ' $fragmentName'?: 'JobDataInspector_LibraryScanOutput_Fragment' }

type JobDataInspector_SeriesScanOutput_Fragment = {
	__typename: 'SeriesScanOutput'
	totalFiles: number
	ignoredFiles: number
	skippedFiles: number
	createdMedia: number
	updatedMedia: number
} & { ' $fragmentName'?: 'JobDataInspector_SeriesScanOutput_Fragment' }

type JobDataInspector_ThumbnailGenerationOutput_Fragment = {
	__typename: 'ThumbnailGenerationOutput'
	visitedFiles: number
	skippedFiles: number
	generatedThumbnails: number
	removedThumbnails: number
} & { ' $fragmentName'?: 'JobDataInspector_ThumbnailGenerationOutput_Fragment' }

export type JobDataInspectorFragment =
	| JobDataInspector_ExternalJobOutput_Fragment
	| JobDataInspector_LibraryScanOutput_Fragment
...
export type JobSchedulerConfigQuery = {
	__typename?: 'Query'
	libraries: {
		__typename?: 'PaginatedLibraryResponse'
		nodes: Array<{ __typename?: 'Library'; id: string; name: string; emoji?: string | null }>
	}
	scheduledJobConfigs: Array<{
		__typename?: 'ScheduledJobConfig'
		id: number
		intervalSecs: number
		scanConfigs: Array<{ __typename?: 'Library'; id: string; name: string }>
	}>
}
...
export type JobSchedulerUpdateMutation = {
	__typename?: 'Mutation'
...
export type JobSchedulerDeleteMutation = {
	__typename?: 'Mutation'
	deleteScheduledJobConfig: boolean
}
...
export type JobSchedulerCreateMutation = {
	__typename?: 'Mutation'
	...
	jobs: {
		...
		nodes: Array<{
			...
			outputData?:
				| ({ __typename?: 'ExternalJobOutput' } & {
						' $fragmentRefs'?: {
							JobDataInspector_ExternalJobOutput_Fragment: JobDataInspector_ExternalJobOutput_Fragment
						}
				  })
				| ({ __typename?: 'LibraryScanOutput' } & {
						' $fragmentRefs'?: {
							JobDataInspector_LibraryScanOutput_Fragment: JobDataInspector_LibraryScanOutput_Fragment
						}
				  })
				| ({ __typename?: 'SeriesScanOutput' } & {
						' $fragmentRefs'?: {
							JobDataInspector_SeriesScanOutput_Fragment: JobDataInspector_SeriesScanOutput_Fragment
						}
				  })
				| ({ __typename?: 'ThumbnailGenerationOutput' } & {
						' $fragmentRefs'?: {
							JobDataInspector_ThumbnailGenerationOutput_Fragment: JobDataInspector_ThumbnailGenerationOutput_Fragment
						}
				  })
				| null
		}>
...
export type DeleteLogsMutation = {
	__typename?: 'Mutation'
	deleteLogs: { __typename?: 'LogDeleteOutput'; deleted: number }
}
...
export type PersistedLogsQuery = {
	__typename?: 'Query'
	logs: {
		__typename?: 'PaginatedLogResponse'
		nodes: Array<{
...
export type CreateOrUpdateUserFormUpdateUserMutation = {
	__typename?: 'Mutation'
	updateUser: {
		__typename?: 'User'
		id: string
		...
		ageRestriction?: { __typename?: 'AgeRestriction'; age: number; restrictOnUnset: boolean } | null
	}
}
...
export type CreateOrUpdateUserFormCreateUserMutation = {
	__typename?: 'Mutation'
...
export type CreateUserSceneQuery = {
	__typename?: 'Query'
	users: {
		__typename?: 'PaginatedUserResponse'
		nodes: Array<{ __typename?: 'User'; username: string }>
	}
}
...
export type UserActionMenuLockUserMutation = {
	__typename?: 'Mutation'
	updateUserLockStatus: { __typename?: 'User'; id: string; isLocked: boolean }
}
...
export type UserActionMenuDeleteUserSessionsMutation = {
	__typename?: 'Mutation'
	deleteUserSessions: number
}
...
export type SmartListsWithSearchQuery = {
	__typename?: 'Query'
	smartLists: Array<{
		__typename?: 'SmartList'
		id: string
...
export type SmartListBasicSettingsSceneQuery = {
	__typename?: 'Query'
	smartLists: Array<{ __typename?: 'SmartList'; name: string }>
}
...
export type DeleteSmartListMutation = {
	__typename?: 'Mutation'
	deleteSmartList: { __typename: 'SmartList' }
}
...
export type SmartListByIdQuery = {
	__typename?: 'Query'
	smartListById?: {
		__typename?: 'SmartList'
		id: string
...
export type SmartListMetaQuery = {
	__typename?: 'Query'
	smartListMeta?: {
		__typename?: 'SmartListMeta'
		matchedBooks: number
...
export type UploadConfigQuery = {
	__typename?: 'Query'
	uploadConfig: { __typename?: 'UploadConfig'; enabled: boolean; maxFileUploadSize: number }
}
...
export const EmailerListItemFragmentDoc = new TypedDocumentString(
  ...
  username
    ...
    `,
	{ fragmentName: 'EmailerListItem' },
) as unknown as TypedDocumentString<EmailerListItemFragment, unknown>
export const JobDataInspectorFragmentDoc = new TypedDocumentString(
  ...
  ... on ExternalJobOutput {
    ...
    `,
	{ fragmentName: 'JobDataInspector' },
) as unknown as TypedDocumentString<JobDataInspectorFragment, unknown>
...
export const UploadLibraryBooksDocument = new TypedDocumentString(`
  ...
  uploadBooks(input: $input)
	...
	UploadLibraryBooksMutation,
	UploadLibraryBooksMutationVariables
>
...
export const UpdateLibraryEmojiDocument = new TypedDocumentString(`
  ...
  updateLibraryEmoji(id: $id, emoji: $emoji) {
    ...
    `) as unknown as TypedDocumentString<
	UpdateLibraryEmojiMutation,
	UpdateLibraryEmojiMutationVariables
>
export const ScanLibraryMutationDocument = new TypedDocumentString(`
  ...
  scanLibrary(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	ScanLibraryMutationMutation,
	ScanLibraryMutationMutationVariables
>
export const LibrarySideBarSectionDocument = new TypedDocumentString(`
  ...
  libraries(pagination: {none: {unpaginated: true}}) {
    ...
    `) as unknown as TypedDocumentString<
	LibrarySideBarSectionQuery,
	LibrarySideBarSectionQueryVariables
>
...
export const UpdateEpubProgressDocument = new TypedDocumentString(`
  ...
  updateEpubProgress(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	UpdateEpubProgressMutation,
	UpdateEpubProgressMutationVariables
>
...
export const BookLibrarySeriesLinksDocument = new TypedDocumentString(`
  ...
  seriesById(id: $id) {
    ...
    `) as unknown as TypedDocumentString<
	BookLibrarySeriesLinksQuery,
	BookLibrarySeriesLinksQueryVariables
>
...
export const UpdateReadProgressDocument = new TypedDocumentString(`
  ...
  updateMediaProgress(id: $id, page: $page) {
    ...
    `) as unknown as TypedDocumentString<
	UpdateReadProgressMutation,
	UpdateReadProgressMutationVariables
>
...
export const CreateLibrarySceneExistingLibrariesDocument = new TypedDocumentString(`
  ...
  libraries(pagination: {none: {unpaginated: true}}) {
	...
	CreateLibrarySceneExistingLibrariesQueryVariables
>
export const CreateLibrarySceneCreateLibraryDocument = new TypedDocumentString(`
  ...
  createLibrary(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateLibrarySceneCreateLibraryMutation,
	CreateLibrarySceneCreateLibraryMutationVariables
>
export const CreateSmartListFormDocument = new TypedDocumentString(`
  ...
  smartLists(input: {mine: true}) {
    ...
    `) as unknown as TypedDocumentString<
	CreateSmartListFormQuery,
	CreateSmartListFormQueryVariables
>
export const CreateSmartListSceneDocument = new TypedDocumentString(`
  ...
  createSmartList(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateSmartListSceneMutation,
	CreateSmartListSceneMutationVariables
>
export const ContinueReadingMediaQueryDocument = new TypedDocumentString(`
  ...
  readHistory {
	...
	ContinueReadingMediaQueryQuery,
	ContinueReadingMediaQueryQueryVariables
>
...
export const RecentlyAddedSeriesQueryDocument = new TypedDocumentString(`
  ...
  recentlyAddedSeries(pagination: $pagination) {
    ...
    `) as unknown as TypedDocumentString<
	RecentlyAddedSeriesQueryQuery,
	RecentlyAddedSeriesQueryQueryVariables
>
...
export const LibraryExclusionsUsersQueryDocument = new TypedDocumentString(`
  ...
  users(pagination: {none: {unpaginated: true}}) {
    ...
    `) as unknown as TypedDocumentString<
	LibraryExclusionsUsersQueryQuery,
	LibraryExclusionsUsersQueryQueryVariables
>
export const LibraryExclusionsQueryDocument = new TypedDocumentString(`
  ...
  libraryById(id: $id) {
    ...
    `) as unknown as TypedDocumentString<
	LibraryExclusionsQueryQuery,
	LibraryExclusionsQueryQueryVariables
>
export const UpdateLibraryExclusionsDocument = new TypedDocumentString(`
  ...
  updateLibraryExcludedUsers(id: $id, userIds: $userIds) {
    ...
    `) as unknown as TypedDocumentString<
	UpdateLibraryExclusionsMutation,
	UpdateLibraryExclusionsMutationVariables
>
...
export const AnalyzeLibraryMediaDocument = new TypedDocumentString(`
  ...
  analyzeMedia(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	AnalyzeLibraryMediaMutation,
	AnalyzeLibraryMediaMutationVariables
>
export const ScanHistorySectionClearHistoryDocument = new TypedDocumentString(`
  ...
  clearScanHistory(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	ScanHistorySectionClearHistoryMutation,
	ScanHistorySectionClearHistoryMutationVariables
>
...
export const ScanRecordInspectorJobsDocument = new TypedDocumentString(`
  ...
  jobById(id: $id) {
    ...
    `) as unknown as TypedDocumentString<
	ScanRecordInspectorJobsQuery,
	ScanRecordInspectorJobsQueryVariables
>
export const DeleteLibraryThumbnailsDocument = new TypedDocumentString(`
  ...
  deleteLibraryThumbnails(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	DeleteLibraryThumbnailsMutation,
	DeleteLibraryThumbnailsMutationVariables
>
export const LibraryThumbnailSelectorUpdateDocument = new TypedDocumentString(`
  ...
  updateLibraryThumbnail(id: $id, input: $input) {
	...
	LibraryThumbnailSelectorUpdateMutationVariables
>
export const LibraryThumbnailSelectorUploadDocument = new TypedDocumentString(`
  ...
  uploadLibraryThumbnail(id: $id, file: $file) {
    ...
    `) as unknown as TypedDocumentString<
	LibraryThumbnailSelectorUploadMutation,
	LibraryThumbnailSelectorUploadMutationVariables
>
export const RegenerateThumbnailsDocument = new TypedDocumentString(`
  ...
  generateLibraryThumbnails(id: $id, forceRegenerate: $forceRegenerate)
    ...
    `) as unknown as TypedDocumentString<
	RegenerateThumbnailsMutation,
	RegenerateThumbnailsMutationVariables
>
...
export const CreateApiKeyModalDocument = new TypedDocumentString(`
  ...
  createApiKey(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateApiKeyModalMutation,
	CreateApiKeyModalMutationVariables
>
export const DeleteApiKeyConfirmModalDocument = new TypedDocumentString(`
  ...
  deleteApiKey(id: $id) {
    ...
    `) as unknown as TypedDocumentString<
	DeleteApiKeyConfirmModalMutation,
	DeleteApiKeyConfirmModalMutationVariables
>
export const UpdateUserLocaleSelectorDocument = new TypedDocumentString(`
  ...
  updateViewerPreferences(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	UpdateUserLocaleSelectorMutation,
	UpdateUserLocaleSelectorMutationVariables
>
export const UpdateUserProfileFormDocument = new TypedDocumentString(`
  ...
  updateViewer(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	UpdateUserProfileFormMutation,
	UpdateUserProfileFormMutationVariables
>
export const CreateEmailerSceneEmailersDocument = new TypedDocumentString(`
  ...
  emailers {
    ...
    `) as unknown as TypedDocumentString<
	CreateEmailerSceneEmailersQuery,
	CreateEmailerSceneEmailersQueryVariables
>
export const CreateEmailerSceneCreateEmailerDocument = new TypedDocumentString(`
  ...
  createEmailer(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateEmailerSceneCreateEmailerMutation,
	CreateEmailerSceneCreateEmailerMutationVariables
>
...
export const EditEmailerSceneEditEmailerDocument = new TypedDocumentString(`
  ...
  updateEmailer(id: $id, input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	EditEmailerSceneEditEmailerMutation,
	EditEmailerSceneEditEmailerMutationVariables
>
export const CreateOrUpdateDeviceModalCreateEmailDeviceDocument = new TypedDocumentString(`
  ...
  createEmailDevice(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateOrUpdateDeviceModalCreateEmailDeviceMutation,
	CreateOrUpdateDeviceModalCreateEmailDeviceMutationVariables
>
export const CreateOrUpdateDeviceModalUpdateEmailDeviceDocument = new TypedDocumentString(`
  ...
  updateEmailDevice(id: $id, input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateOrUpdateDeviceModalUpdateEmailDeviceMutation,
	CreateOrUpdateDeviceModalUpdateEmailDeviceMutationVariables
>
export const DeleteDeviceConfirmationDeleteEmailDeviceDocument = new TypedDocumentString(`
  ...
  deleteEmailDevice(id: $id) {
    ...
    `) as unknown as TypedDocumentString<
	DeleteDeviceConfirmationDeleteEmailDeviceMutation,
	DeleteDeviceConfirmationDeleteEmailDeviceMutationVariables
>
...
export const DeleteJobHistoryConfirmationDocument = new TypedDocumentString(`
  ...
  deleteJobHistory {
    ...
    `) as unknown as TypedDocumentString<
	DeleteJobHistoryConfirmationMutation,
	DeleteJobHistoryConfirmationMutationVariables
>
export const JobActionMenuCancelJobDocument = new TypedDocumentString(`
  ...
  cancelJob(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	JobActionMenuCancelJobMutation,
	JobActionMenuCancelJobMutationVariables
>
export const JobActionMenuDeleteJobDocument = new TypedDocumentString(`
  ...
  cancelJob(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	JobActionMenuDeleteJobMutation,
	JobActionMenuDeleteJobMutationVariables
>
export const JobActionMenuDeleteLogsDocument = new TypedDocumentString(`
  ...
  deleteJobLogs(id: $id) {
    ...
    `) as unknown as TypedDocumentString<
	JobActionMenuDeleteLogsMutation,
	JobActionMenuDeleteLogsMutationVariables
>
...
export const JobSchedulerUpdateDocument = new TypedDocumentString(`
  ...
  updateScheduledJobConfig(id: $id, input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	JobSchedulerUpdateMutation,
	JobSchedulerUpdateMutationVariables
>
export const JobSchedulerDeleteDocument = new TypedDocumentString(`
  ...
  deleteScheduledJobConfig(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	JobSchedulerDeleteMutation,
	JobSchedulerDeleteMutationVariables
>
export const JobSchedulerCreateDocument = new TypedDocumentString(`
  ...
  createScheduledJobConfig(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	JobSchedulerCreateMutation,
	JobSchedulerCreateMutationVariables
>
...
export const LiveLogsFeedDocument = new TypedDocumentString(`
  ...
  tailLogFile
    ...
    `) as unknown as TypedDocumentString<
	LiveLogsFeedSubscription,
	LiveLogsFeedSubscriptionVariables
>
...
export const CreateOrUpdateUserFormUpdateUserDocument = new TypedDocumentString(`
  ...
  updateUser(id: $id, input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateOrUpdateUserFormUpdateUserMutation,
	CreateOrUpdateUserFormUpdateUserMutationVariables
>
export const CreateOrUpdateUserFormCreateUserDocument = new TypedDocumentString(`
  ...
  createUser(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	CreateOrUpdateUserFormCreateUserMutation,
	CreateOrUpdateUserFormCreateUserMutationVariables
>
...
export const UserActionMenuLockUserDocument = new TypedDocumentString(`
  ...
  updateUserLockStatus(id: $id, lock: $lock) {
    ...
    `) as unknown as TypedDocumentString<
	UserActionMenuLockUserMutation,
	UserActionMenuLockUserMutationVariables
>
export const UserActionMenuDeleteUserSessionsDocument = new TypedDocumentString(`
  ...
  deleteUserSessions(id: $id)
    ...
    `) as unknown as TypedDocumentString<
	UserActionMenuDeleteUserSessionsMutation,
	UserActionMenuDeleteUserSessionsMutationVariables
>
...
export const SmartListsWithSearchDocument = new TypedDocumentString(`
  ...
  smartLists(input: $input) {
    ...
    `) as unknown as TypedDocumentString<
	SmartListsWithSearchQuery,
	SmartListsWithSearchQueryVariables
>
export const SmartListBasicSettingsSceneDocument = new TypedDocumentString(`
  ...
  smartLists(input: {mine: true}) {
    ...
    `) as unknown as TypedDocumentString<
	SmartListBasicSettingsSceneQuery,
	SmartListBasicSettingsSceneQueryVariables
>
