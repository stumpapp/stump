...
export type BookOverviewSceneQuery = {
	...
	mediaById?:
		| ({
		  ...
		  } & { ' $fragmentRefs'?: { BookOverviewHeaderFragment: BookOverviewHeaderFragment } })
		| null
}

export type BookOverviewHeaderFragment = {
	__typename?: 'Media'
	id: string
	resolvedName: string
	pages: number
...
} & { ' $fragmentName'?: 'BookOverviewHeaderFragment' }
...
export const BookOverviewHeaderFragmentDoc = new TypedDocumentString(
  ...
  tags {
    ...
    `,
	{ fragmentName: 'BookOverviewHeader' },
) as unknown as TypedDocumentString<BookOverviewHeaderFragment, unknown>
