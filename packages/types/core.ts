...
export type User = { id: string; username: string; role: string; user_preferences?: UserPreferences | null; avatar_url: string | null; age_restriction?: AgeRestriction | null; read_progresses?: ReadProgress[] | null; created_at: string; last_login: string | null }
