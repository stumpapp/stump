 ...
 */
export type ImageSizeFactor = number | [number, number] | [number, number]
 ...
 */
export type ImageProcessorOptions = { size_factor: ImageSizeFactor | null; format: ImageFormat; quality: number | null }
