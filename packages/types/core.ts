...
export type User = { id: string; username: string; role: string; user_preferences: UserPreferences | null; avatar_url: string | null; read_progresses: ReadProgress[] | null; created_at: string; last_login: string | null }
...
export type UpdateUserPreferences = { id: string; locale: string; library_layout_mode: string; series_layout_mode: string; collection_layout_mode: string; app_theme: string }
...
export type SeriesMetadata = { _type: string; title: string | null; summary: string | null; publisher: string | null; imprint: string | null; comicid: number | null; volume: number | null; booktype: string | null; age_rating: string | null; status: string | null }
 ...
 */
export type MediaMetadata = { title: string | null; series: string | null; number: number | null; volume: number | null; summary: string | null; notes: string | null; genre: string[] | null; year: number | null; month: number | null; day: number | null; writers: string[] | null; pencillers: string[] | null; inkers: string[] | null; colorists: string[] | null; letterers: string[] | null; cover_artists: string[] | null; editors: string[] | null; publisher: string | null; links: string[] | null; characters: string[] | null; teams: string[] | null; page_count: number | null }
