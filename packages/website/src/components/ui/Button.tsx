...
export const BUTTON_VARIANTS = {
	ghost:
		'bg-transparent dark:shadow-sm hover:bg-gray-75 active:bg-gray-50 dark:bg-transparent dark:active:bg-gray-650 dark:hover:bg-gray-700 border-transparent hover:border-gray-200 active:border-gray-200 dark:border-transparent dark:active:border-gray-650 dark:hover:border-gray-550 text-gray-700 hover:text-gray-900 active:text-gray-600 dark:text-gray-200 dark:active:text-white dark:hover:text-white',
	primary:
		'bg-gray-100 dark:shadow-sm hover:bg-gray-200 active:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-750 dark:active:bg-gray-650 border-gray-250 hover:border-gray-300 active:border-gray-200 dark:border-gray-600 dark:active:border-gray-600 dark:hover:border-gray-500 text-gray-700hover:text-gray-900 active:text-gray-600 dark:text-gray-200  dark:active:text-white dark:hover:text-white',
	brand:
